...
<div className="sticky top-20 w-full flex flex-wrap items-start transition-all duration-300">
  ...
  <div className="w-full mb-5">
    <ul className="m-0 p-0 list-none">
      <li className="mb-1">
        <a href="#" className="flex items-center w-full p-[15px_24px] text-[15px] text-black bg-[#f7f8fa] transition-colors duration-300">
          Research and Development
          <span className="ml-auto flex items-center"><i className="text-[15px]"></i></span>
        </a>
      </li>
      <li className="mb-1">
        <a href="#" className="flex items-center w-full p-[15px_24px] text-[15px] text-black bg-[#f7f8fa] transition-colors duration-300">
  ...
  <section className="w-full mt-[45px]">
    <div className="max-w-[1140px] mx-auto relative">
      <div className="w-full p-[35px_20px] bg-[#f7f8fa] rounded-md mb-8">
        {/* <!-- Heading --> */}
        <h3 className="text-[19px] font-bold text-[#181b31] mb-3">Get a Free Quote</h3>
  ...
  <div className="w-full mb-5 relative">
    <div className="mb-16 relative transition duration-300">
      <div className="relative pt-[443px] perspective-[1200px]">
        {/* <!-- Image Wrapper --> */}
        <div className="absolute inset-0 h-[443px] w-full transition-none">
          <div className="absolute inset-0 h-[443px] w-full overflow-hidden rounded transition duration-700">
            <figure className="h-[443px] w-full bg-cover bg-center">
              <img
